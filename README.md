# Blog App
A Blog app using django framework. Frontend using html, css and bootstrap and backend using sqlite3. 
...
## Setting up the Project
  ...
  * Fork the Repository.
  * Clone the repository to your local machine `$ git clone https://github.com/<your-github-username>/blog-app.git`
  * Change directory to blog-app `$ cd blog-app`
